...
?>
    <div class="cleantheme-comments">
        <h2 class="cleantheme-postheader nocomments"><?php _e('This post is password protected. Enter the password to view any comments.', THEME_NS) ?></h2>
    </div>
<?php
	return;
}
...
?>
    <div class="cleantheme-comments">
        <h2 class="cleantheme-postheader comments"><?php printf(
...
echo str_replace(
    ...
    array('id="respond" class="cleantheme-commentsform"', '<h2', 'id="reply-title" class="cleantheme-postheader"', '</h2>', 'cleantheme-postcontent logged-in-as', 'class="cleantheme-button" type="submit"'), 
    theme_ob_get_clean());